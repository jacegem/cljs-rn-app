...
var temp__5735__auto___56472 = cljs.core.seq(seq__56354_56459);
if(temp__5735__auto___56472){
var seq__56354_56473__$1 = temp__5735__auto___56472;
if(cljs.core.chunked_seq_QMARK_(seq__56354_56473__$1)){
var c__4556__auto___56474 = cljs.core.chunk_first(seq__56354_56473__$1);
var G__56475 = cljs.core.chunk_rest(seq__56354_56473__$1);
var G__56476 = c__4556__auto___56474;
var G__56477 = cljs.core.count(c__4556__auto___56474);
var G__56478 = (0);
seq__56354_56459 = G__56475;
chunk__56355_56460 = G__56476;
count__56356_56461 = G__56477;
i__56357_56462 = G__56478;
continue;
} else {
var vec__56371_56479 = cljs.core.first(seq__56354_56473__$1);
var k_56480 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56371_56479,(0),null);
var s_56481 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56371_56479,(1),null);
var synthetic_QMARK__56482 = (function (){var and__4115__auto__ = spec_tools.core.spec_QMARK_(s_56481);
if(cljs.core.truth_(and__4115__auto__)){
return (!(spec_tools.parse.collection_type_QMARK_(s_56481)));
} else {
return and__4115__auto__;
}
})();
spec_tools.impl.register_spec_BANG_(k_56480,(function (){var G__56374 = s_56481;
if(cljs.core.truth_(synthetic_QMARK__56482)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__56374,new cljs.core.Keyword("spec-tools.core","synthetic?","spec-tools.core/synthetic?",-2118167094),true);
} else {
return G__56374;
}
})());
...
var G__56487 = cljs.core.next(seq__56354_56473__$1);
var G__56488 = null;
var G__56489 = (0);
var G__56490 = (0);
seq__56354_56459 = G__56487;
chunk__56355_56460 = G__56488;
count__56356_56461 = G__56489;
i__56357_56462 = G__56490;
continue;
}
} else {
}
...
spec_tools.data_spec._coll_spec = (function spec_tools$data_spec$_coll_spec(data,p__56375){
...
var n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56376__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var kind = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56376__$1,new cljs.core.Keyword(null,"kind","kind",-717265803));
...
var spec = (function (){var G__56378 = n;
var G__56379 = cljs.core.first(data);
return (spec_tools.data_spec.spec.cljs$core$IFn$_invoke$arity$2 ? spec_tools.data_spec.spec.cljs$core$IFn$_invoke$arity$2(G__56378,G__56379) : spec_tools.data_spec.spec.call(null,G__56378,G__56379));
})();
...
return spec_tools.impl.or_spec(cljs.core.into.cljs$core$IFn$_invoke$arity$2((function (){var iter__4529__auto__ = (function spec_tools$data_spec$_or_spec_$_iter__56380(s__56381){
return (new cljs.core.LazySeq(null,(function (){
var s__56381__$1 = s__56381;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__56381__$1);
if(temp__5735__auto__){
var s__56381__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__56381__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__56381__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__56383 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__56382 = (0);
while(true){
if((i__56382 < size__4528__auto__)){
var vec__56384 = cljs.core._nth(c__4527__auto__,i__56382);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56384,(0),null);
var v__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56384,(1),null);
cljs.core.chunk_append(b__56383,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,(function (){var G__56387 = spec_tools.data_spec._nested_key(n,k);
var G__56388 = v__$1;
return (spec_tools.data_spec.spec.cljs$core$IFn$_invoke$arity$2 ? spec_tools.data_spec.spec.cljs$core$IFn$_invoke$arity$2(G__56387,G__56388) : spec_tools.data_spec.spec.call(null,G__56387,G__56388));
})()], null));

var G__56496 = (i__56382 + (1));
i__56382 = G__56496;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56383),spec_tools$data_spec$_or_spec_$_iter__56380(cljs.core.chunk_rest(s__56381__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__56383),null);
}
} else {
var vec__56389 = cljs.core.first(s__56381__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56389,(0),null);
var v__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56389,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,(function (){var G__56392 = spec_tools.data_spec._nested_key(n,k);
var G__56393 = v__$1;
return (spec_tools.data_spec.spec.cljs$core$IFn$_invoke$arity$2 ? spec_tools.data_spec.spec.cljs$core$IFn$_invoke$arity$2(G__56392,G__56393) : spec_tools.data_spec.spec.call(null,G__56392,G__56393));
})()], null),spec_tools$data_spec$_or_spec_$_iter__56380(cljs.core.rest(s__56381__$2)));
}
} else {
return null;
}
...
(spec_tools.data_spec.spec.cljs$core$IFn$_invoke$arity$1 = (function (p__56398){
var map__56399 = p__56398;
var map__56399__$1 = (((((!((map__56399 == null))))?(((((map__56399.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__56399.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__56399):map__56399);
var opts = map__56399__$1;
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56399__$1,new cljs.core.Keyword(null,"spec","spec",347520401));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56399__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var nested_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56399__$1,new cljs.core.Keyword("spec-tools.data-spec","nested?","spec-tools.data-spec/nested?",-662981973));
...
var named_spec = (function (p1__56394_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__56394_SHARP_,new cljs.core.Keyword(null,"name","name",1843675177),name);
});
var maybe_named_spec = (function (p1__56395_SHARP_){
var G__56401 = p1__56395_SHARP_;
if(cljs.core.not(nested_QMARK_)){
return named_spec(G__56401);
} else {
return G__56401;
}
});

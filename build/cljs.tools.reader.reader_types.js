...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_42084 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_42084(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_42089 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_42089(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_42090 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_42090(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_42092 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_42092(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_42096 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_42096(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_42097 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_42097(reader);
}
});
...
var G__42172 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__42173 = s.append(c);
c = G__42172;
s = G__42173;
continue;
}
